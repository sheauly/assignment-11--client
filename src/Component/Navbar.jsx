...
const Navbar = () => {
    ...
    const navLinks = (
        <>
            <li><NavLink to="/" className={({ isActive }) => isActive ? "text-secondary font-semibold" : "text-green-700 hover:text-green-700"}>Home</NavLink></li>
            <li><NavLink to="/allFoods" className={({ isActive }) => isActive ? "text-secondary font-semibold" : "text-green-700 hover:text-green-700"}>AllFoods</NavLink></li>
    ...
    return (
        <div className="bg-amber-50 shadow-sm sticky top-0 z-50">
